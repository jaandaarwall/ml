        ...
        <div class="row justify-content-center mt-3">
            <div class="col-6  align-items-center">
                ...
                <form @submit.prevent="register"> 
                    <!-- this will prevent the form from submitting and call the register function -->
                     <div class="mb-3">
                        <label for="exampleInputUsername1" class="form-label">Username</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" aria-describedby="emailHelp" v-model="username">
                    </div>
                    <div class="mb-3">
